...
from .views.bays_views import ChangeStatusBay, GetBayDetail, ChangeComponent, RemoveComponent
...
urlpatterns = [
    ...
    path('bay-component-remove/<int:id>', RemoveComponent.as_view(), name="remove_component_bay"),
]
